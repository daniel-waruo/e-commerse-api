...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Order',
            fields=[
                ('id', shortuuidfield.fields.ShortUUIDField(blank=True, default='mZriazSUfHjHjyu9ahE8iJ', editable=False, max_length=22, primary_key=True, serialize=False)),
                ('state', models.CharField(choices=[('pending', 'Pending'), ('cancelled', 'Cancelled'), ('shipping', 'Shipping'), ('received', 'Received')], default='pending', max_length=10)),
                ('date_added', models.DateField(auto_now_add=True)),
                ('delivery_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='delivery.DeliveryInfo')),
                ('receipt', models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, to='payment.Receipt')),
