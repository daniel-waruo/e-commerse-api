...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('id',
                 shortuuidfield.fields.ShortUUIDField(blank=True, default='BwSi2q9osByoWHAP8bo87A', editable=False,
                                                      max_length=22, primary_key=True, serialize=False)),
                ('state', models.CharField(
                    choices=[('pending', 'Pending'), ('cancelled', 'Cancelled'), ('shipping', 'Shipping'),
                             ('received', 'Received')], default='pending', max_length=10)),
