...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Order',
            fields=[
                ('id', shortuuidfield.fields.ShortUUIDField(blank=True, default='go7SdF9H7y8Qhmq8daAX4H', editable=False, max_length=22, primary_key=True, serialize=False)),
                ('state', models.CharField(choices=[('pend', 'Pending'), ('del', 'Cancelled'), ('shipping', 'Shipping'), ('received', 'Received')], default='init', max_length=4)),
